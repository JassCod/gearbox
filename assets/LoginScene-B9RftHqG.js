...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Hc(e,t,n){return new Ro({name:`SphericalGaussianBlur`,defines:{SAMPLES:Dc,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},sigma:{value:0},mipInt:{value:0}},vertexShader:Gc(),fragmentShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`};var zf={name:`CopyShader`,uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};Xf.BlurDirectionX=new K(1,0),Xf.BlurDirectionY=new K(0,1);var Zf={name:`OutputShader`,uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
		precision highp float;
		...
		}`},Qf=class extends Bf{constructor(){super(),this.isOutputPass=!0,this.uniforms=Fo.clone(Zf.uniforms),this.material=new zo({name:Zf.name,uniforms:this.uniforms,vertexShader:Zf.vertexShader,fragmentShader:Zf.fragmentShader}),this._fsQuad=new Uf(this.material),this._outputColorSpace=null,this._toneMapping=null}render(e,t,n){this.uniforms.tDiffuse.value=n.texture,this.uniforms.toneMappingExposure.value=e.toneMappingExposure,(this._outputColorSpace!==e.outputColorSpace||this._toneMapping!==e.toneMapping)&&(this._outputColorSpace=e.outputColorSpace,this._toneMapping=e.toneMapping,this.material.defines={},Y.getTransfer(this._outputColorSpace)===`srgb`&&(this.material.defines.SRGB_TRANSFER=``),this._toneMapping===1?this.material.defines.LINEAR_TONE_MAPPING=``:this._toneMapping===2?this.material.defines.REINHARD_TONE_MAPPING=``:this._toneMapping===3?this.material.defines.CINEON_TONE_MAPPING=``:this._toneMapping===4?this.material.defines.ACES_FILMIC_TONE_MAPPING=``:this._toneMapping===6?this.material.defines.AGX_TONE_MAPPING=``:this._toneMapping===7?this.material.defines.NEUTRAL_TONE_MAPPING=``:this._toneMapping===5&&(this.material.defines.CUSTOM_TONE_MAPPING=``),this.material.needsUpdate=!0),this.renderToScreen===!0?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},$f=new q;function ep(e,t,n,r,i,a){let o=2*Math.PI*i/4,s=Math.max(a-2*i,0),c=Math.PI/4;$f.copy(t),$f[r]=0,$f.normalize();let l=.5*o/(o+s),u=1-$f.angleTo(e)/c;return Math.sign($f[n])===1?u*l:s/(o+s)+l+l*(1-u)}var tp=class e extends ia{constructor(e=1,t=1,n=1,r=2,i=.1){let a=r*2+1;if(i=Math.min(e/2,t/2,n/2,i),super(1,1,1,a,a,a),this.type=`RoundedBoxGeometry`,this.parameters={width:e,height:t,depth:n,segments:r,radius:i},a===1)return;let o=this.toNonIndexed();this.index=null,this.attributes.position=o.attributes.position,this.attributes.normal=o.attributes.normal,this.attributes.uv=o.attributes.uv;let s=new q,c=new q,l=new q(e,t,n).divideScalar(2).subScalar(i),u=this.attributes.position.array,d=this.attributes.normal.array,f=this.attributes.uv.array,p=u.length/6,m=new q,h=.5/a;for(let r=0,a=0;r<u.length;r+=3,a+=2)switch(s.fromArray(u,r),c.copy(s),c.x-=Math.sign(c.x)*h,c.y-=Math.sign(c.y)*h,c.z-=Math.sign(c.z)*h,c.normalize(),u[r+0]=l.x*Math.sign(s.x)+c.x*i,u[r+1]=l.y*Math.sign(s.y)+c.y*i,u[r+2]=l.z*Math.sign(s.z)+c.z*i,d[r+0]=c.x,d[r+1]=c.y,d[r+2]=c.z,Math.floor(r/p)){case 0:m.set(1,0,0),f[a+0]=ep(m,c,`z`,`y`,i,n),f[a+1]=1-ep(m,c,`y`,`z`,i,t);break;case 1:m.set(-1,0,0),f[a+0]=1-ep(m,c,`z`,`y`,i,n),f[a+1]=1-ep(m,c,`y`,`z`,i,t);break;case 2:m.set(0,1,0),f[a+0]=1-ep(m,c,`x`,`z`,i,e),f[a+1]=ep(m,c,`z`,`x`,i,n);break;case 3:m.set(0,-1,0),f[a+0]=1-ep(m,c,`x`,`z`,i,e),f[a+1]=1-ep(m,c,`z`,`x`,i,n);break;case 4:m.set(0,0,1),f[a+0]=1-ep(m,c,`x`,`y`,i,e),f[a+1]=1-ep(m,c,`y`,`x`,i,t);break;case 5:m.set(0,0,-1),f[a+0]=ep(m,c,`x`,`y`,i,e),f[a+1]=1-ep(m,c,`y`,`x`,i,t)}}static fromJSON(t){return new e(t.width,t.height,t.depth,t.segments,t.radius)}};function np(e,t){let n=new Tn,r=new Tn,i=new Tn,a=new Tn;n.add(r,i,a);let o=t=>e(new Bo(t)),s={paint:e(new Vo({color:`#e7ebee`,metalness:.15,roughness:.34,clearcoat:1,clearcoatRoughness:.2})),accent:e(new Vo({color:`#0f6a66`,metalness:.45,roughness:.3,clearcoat:1,clearcoatRoughness:.12})),black:o({color:`#141619`,roughness:.62,metalness:.1}),plastic:o({color:`#2a2e33`,roughness:.5,metalness:.15}),chrome:o({color:`#e3e8ee`,metalness:1,roughness:.14}),alu:o({color:`#c7ccd1`,metalness:1,roughness:.3}),frame:o({color:`#1b1c1f`,metalness:.4,roughness:.55}),glass:e(new Vo({color:`#0a0e13`,metalness:.1,roughness:.03,clearcoat:1,clearcoatRoughness:.02,envMapIntensity:1.5})),mirror:o({color:`#b8c0cc`,metalness:1,roughness:.03}),lens:o({color:`#e8eef5`,emissive:`#fff4e2`,emissiveIntensity:2.2,roughness:.1}),drl:o({color:`#ffffff`,emissive:`#f2f7ff`,emissiveIntensity:6}),amber:o({color:`#ffb54a`,emissive:`#ff9a1a`,emissiveIntensity:3}),red:o({color:`#ff3b30`,emissive:`#ff1a0a`,emissiveIntensity:2.5}),rubber:o({color:`#151515`,roughness:.88}),rim:o({color:`#d5dade`,metalness:1,roughness:.2})},c=new Map,l=new sn,u=new kt,d=new X,f=new q(1,1,1),p=(e,t,n,r,i,a,o=0,s=0,p=0,m=f)=>{let h=t.index?t.toNonIndexed():t;h!==t&&t.dispose();for(let e of Object.keys(h.attributes))[`position`,`normal`,`uv`].includes(e)||h.deleteAttribute(e);h.applyMatrix4(d.compose(new q(r,i,a),u.setFromEuler(l.set(o,s,p)),m)),c.has(e)||c.set(e,new Map);let g=c.get(e);g.has(n)||g.set(n,[]),g.get(n).push(h)},m=(e,t,n,r,i=3)=>new tp(e,t,n,i,Math.min(r,e/2-.001,t/2-.001,n/2-.001)),h=(e,t,n)=>new ia(e,t,n),g=(e,t,n,r=16)=>new oa(e,t,n,r),_=(e,t,n,r)=>{let i=new La;r?r(i):(i.moveTo(e[0][0],e[0][1]),e.slice(1).forEach(([e,t])=>i.lineTo(e,t)));let a=new So(i,{depth:t-n*2,bevelEnabled:!0,bevelThickness:n,bevelSize:n,bevelSegments:5,curveSegments:10});return a.rotateY(-Math.PI/2),a.translate((t-n*2)/2,0,0),a},v=(e,t)=>{let n=new Do(new La(e.map(([e,n])=>new K(t>0?-e:e,n))));return n.rotateY(t>0?Math.PI/2:-Math.PI/2),n.translate(t,0,0),n};p(i,_([],2.5,.17,e=>{e.moveTo(.66,1.22),e.lineTo(2.62,1.22),e.lineTo(2.72,1.62),e.lineTo(2.74,2.26),e.lineTo(2.7,2.42),e.lineTo(2.48,3.4),e.quadraticCurveTo(2.44,3.62,2.24,3.64),e.lineTo(.92,3.76),e.quadraticCurveTo(.66,3.78,.66,3.55),e.lineTo(.66,1.22)}),s.paint,0,0,0),p(i,_([[2.05,3.66],[.95,4.2],[.7,4.22],[.7,3.7]],2.3,.06),s.paint,0,0,0);let y=new K(.976,.219),b=-Math.atan2(.219,.976),x=new K(2.59,2.91).addScaledVector(y,.18200000000000002);p(i,m(2.26,1.06,.02,.06),s.black,0,x.y-y.y*.006,x.x-y.x*.006,b),p(i,m(2.16,.98,.02,.06),s.glass,0,x.y,x.x,b);for(let e of[-.5,.55])p(i,h(.95,.025,.025),s.black,e,2.5,2.9,b,0,e>0?.06:-.06);for(let e of[-1,1]){let t=e*1.254;p(i,v([[1.5,2.42],[2.58,2.42],[2.36,3.28],[1.5,3.28]],t*1.0005),s.black,0,0,0),p(i,v([[1.55,2.47],[2.51,2.47],[2.32,3.23],[1.55,3.23]],t*1.001),s.glass,0,0,0),p(i,h(.012,2.05,.014),s.black,t*1.001,2.28,1.44),p(i,h(.012,1.18,.014),s.black,t*1.001,1.83,2.64),p(i,m(.03,.05,.22,.012),s.black,t*1.006,2.25,1.64),p(i,g(.022,.022,.95,10),s.chrome,t*1.035,1.95,1.33),p(i,g(.025,.025,.36,8),s.black,e*1.42,3.12,2.52,0,0,Math.PI/2),p(i,m(.12,.66,.26,.05),s.paint,e*1.62,2.92,2.55),p(i,h(.1,.6,.02),s.mirror,e*1.62,2.92,2.41),p(i,m(.1,.26,.2,.04),s.black,e*1.6,2.4,2.55),p(i,g(.02,.02,.5,8),s.black,e*1.58,2.64,2.55),p(i,h(.06,.64,1.02),s.black,e*1.2,.86,2.02);for(let t of[.62,.98])p(i,h(.24,.04,.96),s.alu,e*1.14,t,2.02);p(i,h(.04,1.9,.5),s.accent,e*1.2,2.65,.42),p(i,h(.012,.16,1.9),s.accent,t*1.002,1.42,1.66)}p(i,m(1.86,.66,.06,.04),s.black,0,1.92,2.91);let S=(()=>{let n=document.createElement(`canvas`);n.width=512,n.height=64;let r=n.getContext(`2d`);r.fillStyle=`#e9eef2`,r.font=`800 50px Inter, "Segoe UI", system-ui, sans-serif`,r.textAlign=`center`,r.textBaseline=`middle`,r.fillText(`T O R Q L I N E`,256,34);let i=e(new ea(n));return i.colorSpace=Be,i.anisotropy=t,i})(),C=new ti(e(new Eo(1.1,.14)),o({map:S,transparent:!0,metalness:.6,roughness:.3}));C.position.set(0,2.17,2.975),i.add(C);for(let e=0;e<5;e++)p(i,h(1.74,.045,.03),e===2?s.chrome:s.plastic,0,1.68+e*.12,2.945);for(let e of[-1,1])p(i,m(.66,.3,.12,.05),s.black,e*.88,1.38,2.9),p(i,m(.24,.17,.03,.04),s.lens,e*.99,1.37,2.97),p(i,m(.2,.15,.03,.04),s.lens,e*.74,1.37,2.97),p(i,h(.54,.03,.02),s.drl,e*.88,1.5,2.97),p(i,h(.08,.14,.03),s.amber,e*1.16,1.37,2.95),p(i,g(.065,.065,.04,20),s.lens,e*.98,.86,3.14,Math.PI/2);p(i,m(2.58,.54,.4,.09),s.plastic,0,.94,2.95),p(i,h(2.36,.08,.34),s.black,0,.64,2.97),p(i,m(.56,.16,.02,.02),s.chrome,0,.97,3.155),p(i,m(2.3,.05,.36,.02),s.paint,0,3.6,2.6,.14);for(let e=-2;e<=2;e++)p(i,m(.1,.035,.05,.012),s.amber,e*.42,3.575,2.79);let w=(e,t,n,r)=>new oa(e,e,t,24,1,!0,n,r);for(let e of[-1,1])p(r,w(.62,.42,Math.PI*.55,Math.PI*.75),s.black,e*1.05,.53,2.15,0,0,Math.PI/2);for(let e of[-1,1])p(r,h(.1,.3,7.9),s.frame,e*.42,.92,-1.35);p(r,h(1.9,.12,.14),s.frame,0,.55,2.15);for(let e of[-2.45,-3.8])p(r,g(.12,.12,1.9,12),s.frame,0,.53,e,0,0,Math.PI/2);p(r,m(.62,.62,1.7,.16,4),s.alu,-.95,.82,-.35);for(let e of[-.95,.25])p(r,h(.66,.66,.05),s.black,-.95,.82,e);p(r,g(.06,.06,.05,16),s.chrome,-.95,1.15,.05),p(r,m(.55,.55,1.2,.05),s.black,.95,.82,-.3),p(r,h(1.25,.1,1.1),s.frame,0,1.13,-3);for(let e of[-1,1]){for(let t of[-2.45,-3.8])p(r,w(.62,.68,Math.PI*.2,Math.PI*.6),s.black,e*.94,.53,t,0,0,Math.PI/2);p(r,h(.66,.6,.02),s.black,e*.94,.52,-4.5)}let T=(e,t)=>{let n=[];for(let e=0;e<=60;e++){let r=e/60;n.push(new q(t+Math.sin(r*40)*.05,2.1-Math.sin(r*Math.PI)*.35,.34-r*.7+Math.cos(r*40)*.05))}p(r,new ko(new ga(n),120,.012,6),o({color:e,roughness:.5}),0,0,0)};T(`#c62828`,-.25),T(`#1e5bd6`,0),T(`#1a1a1a`,.25);let E=13.6,D=2.9,O=2.55,k=-.45-E/2,A=(()=>{let n=document.createElement(`canvas`);n.width=2048,n.height=436;let r=n.getContext(`2d`),i=r.createLinearGradient(0,0,0,436);i.addColorStop(0,`#f7f8f9`),i.addColorStop(1,`#dde2e6`),r.fillStyle=i,r.fillRect(0,0,2048,436);for(let e=0;e<=2048;e+=128){r.fillStyle=`rgba(40,50,60,.12)`,r.fillRect(e,0,2,436),r.fillStyle=`rgba(40,50,60,.22)`;for(let t=10;t<436;t+=18)r.fillRect(e-5,t,2,2)}r.fillStyle=`#0e6f68`,r.beginPath(),r.moveTo(0,330),r.bezierCurveTo(700,300,1300,360,2048,300),r.lineTo(2048,436),r.lineTo(0,436),r.fill(),r.fillStyle=`#f59e0b`,r.beginPath(),r.moveTo(0,318),r.bezierCurveTo(700,288,1300,348,2048,288),r.lineTo(2048,298),r.bezierCurveTo(1300,358,700,298,0,328),r.fill(),r.fillStyle=`#0b3b37`,r.font=`800 170px Inter, "Segoe UI", system-ui, sans-serif`,r.fillText(`TORQLINE`,110,210),r.fillStyle=`#3d5561`,r.font=`600 46px Inter, "Segoe UI", system-ui, sans-serif`,r.fillText(`Fleet maintenance  ·  Compliance  ·  Cold chain`,118,272),r.fillStyle=`#ffffff`,r.font=`600 34px Inter, "Segoe UI", system-ui, sans-serif`,r.fillText(`torqline fleet`,1760,400);let a=e(new ea(n));return a.colorSpace=Be,a.anisotropy=t,a})(),j=o({color:`#eceff2`,roughness:.42,metalness:.15}),M=o({map:A,roughness:.4,metalness:.15}),N=new ti(e(new tp(O,D,E,2,.04)),[M,M,j,j,j,j]);N.position.set(0,2.8,k),N.castShadow=!0,N.receiveShadow=!0,a.add(N);for(let e of[-1,1]){p(a,h(.05,.12,E),s.alu,e*1.285,4.2,k),p(a,h(.06,.16,E),s.alu,e*1.285,1.4100000000000001,k);for(let t of[-.48,-14.02])p(a,h(.08,D,.08),s.alu,e*(O/2-.02),2.8,t);for(let t=-1.25;t>-14.049999999999999;t-=1.9)p(a,h(.03,.05,.1),s.amber,e*1.315,1.4100000000000001,t);for(let t of[.62,.98])p(a,h(.05,.1,4.6),s.alu,e*1.2,t,-7.6);for(let t of[-5.5,-7.6,-9.7])p(a,h(.05,.55,.08),s.frame,e*1.18,1.08,t);p(a,h(.14,1,.14),s.frame,e*.85,.85,-4.95),p(a,h(.3,.04,.3),s.frame,e*.85,.34,-4.95),p(a,h(.52,.04,4.1),s.black,e*1.02,1.14,-11.5),p(a,h(.5,.55,.02),s.black,e*1.02,.6,-13.55)}p(a,g(.02,.02,.35,8),s.frame,-1,.95,-4.95,0,0,Math.PI/2),p(a,h(2.4499999999999997,.2,13.4),s.frame,0,1.27,k),p(a,m(2.1,1.7,.42,.08),j,0,3.3,-.25),p(a,m(1.5,.9,.04,.03),s.black,0,3.45,-.030000000000000027);for(let e=0;e<7;e++)p(a,h(1.42,.03,.02),s.plastic,0,3.08+e*.12,-.0050000000000000044);for(let e of[-1,1])p(a,m(.34,.12,.05,.02),s.red,e*.95,1.25,-14.069999999999999);p(a,h(2.3,.12,.12),s.frame,0,.62,-13.85);for(let[t,n]of c)for(let[r,i]of n){let n=e(jd(i));i.forEach(e=>e.dispose());let a=new ti(n,r);a.castShadow=!0,a.receiveShadow=!0,t.add(a)}let P=.53,ee=e(new To([[.29,-.13],[.4,-.152],[.47,-.158],[.51,-.15],[.528,-.125],[P,-.08],[P,0],[P,.08],[.528,.125],[.51,.15],[.47,.158],[.4,.152],[.29,.13]].map(([e,t])=>new K(e,t)),56).rotateZ(-Math.PI/2)),te=(()=>{let n=document.createElement(`canvas`);n.width=1024,n.height=64;let r=n.getContext(`2d`);r.fillStyle=`#808080`,r.fillRect(0,0,1024,64),r.fillStyle=`#1a1a1a`;for(let e=0;e<1024;e+=16)r.fillRect(e,22,5,20),r.fillRect(e+8,20,3,6),r.fillRect(e+8,38,3,6);for(let e of[27,36])r.fillRect(0,e,1024,2);let i=e(new ea(n));return i.anisotropy=t,i})();s.rubber.bumpMap=te,s.rubber.bumpScale=2;let ne=[new To([[.02,.1],[.07,.1],[.075,.125],[.1,.13],[.105,.105],[.19,.092],[.24,.1],[.275,.125],[.3,.14],[.305,.12],[.3,-.1]].map(([e,t])=>new K(e,t)),40).rotateZ(-Math.PI/2).toNonIndexed()];for(let e=0;e<10;e++){let t=e/10*Math.PI*2;ne.push(new oa(.017,.017,.05,6).rotateZ(Math.PI/2).translate(.125,Math.sin(t)*.15,Math.cos(t)*.15).toNonIndexed())}ne.push(new oa(.05,.07,.06,16).rotateZ(Math.PI/2).translate(.13,0,0).toNonIndexed()),ne.forEach(e=>{for(let t of Object.keys(e.attributes))[`position`,`normal`,`uv`].includes(t)||e.deleteAttribute(t)});let F=e(jd(ne));ne.forEach(e=>e.dispose());let re=[];for(let e of[-1,1]){re.push({x:e*1.05,z:2.15,left:e<0,wide:1});for(let t of[-2.45,-3.8])re.push({x:e*1.1,z:t,left:e<0,wide:1}),re.push({x:e*.77,z:t,left:e>0,wide:1});for(let t of[-10.2,-11.5,-12.8])re.push({x:e*1,z:t,left:e<0,wide:1.35})}let ie=new Di(ee,s.rubber,re.length),ae=new Di(F,s.rim,re.length);ie.castShadow=!0,ie.receiveShadow=!0,ae.receiveShadow=!0,r.add(ie,ae);let oe=new kt,se=new q,I=new q,L=new sn,ce=0,le=()=>{re.forEach((e,t)=>{L.set(e.left?-ce:ce,e.left?Math.PI:0,0,`YXZ`),oe.setFromEuler(L),se.set(e.x,P,e.z),I.set(e.wide,1,1),d.compose(se,oe,I),ie.setMatrixAt(t,d),ae.setMatrixAt(t,d)}),ie.instanceMatrix.needsUpdate=!0,ae.instanceMatrix.needsUpdate=!0};le();let ue=[];for(let e of[-1,1]){let t=new zs(`#fff1dc`,170,70,.42,.95,1.5);t.position.set(e*.9,1.38,3),t.target.position.set(e*1.6,0,30),i.add(t,t.target),ue.push(t)}return{root:n,headlights:ue,update(e,t){ce+=t,le(),i.position.y=Math.sin(e*5.3)*.004+Math.sin(e*8.9)*.002,i.rotation.x=Math.sin(e*1.6)*.0035,i.rotation.z=Math.sin(e*1.1)*.003,a.rotation.z=Math.sin(e*.8+1)*.0022}}}var rp=t(),ip=`./assets/car.glb`,ap=48,op=25,sp=8;function cp({onReady:e}){let t=(0,r.useRef)(null);return(0,r.useEffect)(()=>{let n=t.current;if(!n)return;let r;try{r=new Ad({antialias:!1,powerPreference:`high-performance`})}catch{e?.();return}let i=!1,o=window.matchMedia?.(`(prefers-reduced-motion: reduce)`).matches,s=Math.min(window.devicePixelRatio,1.5);r.setPixelRatio(s),r.outputColorSpace=Be,r.toneMapping=4,r.toneMappingExposure=1.12,r.shadowMap.enabled=!0,r.shadowMap.type=2,n.appendChild(r.domElement);let c=[],l=e=>(c.push(e),e),u=new Pn,d=new Ls(30,1,.1,3e3),f=new q().setFromSphericalCoords(1,Ot.degToRad(90.6),Ot.degToRad(150)),p=e=>{let t=new Rf;t.scale.setScalar(e);let n=t.material.uniforms;return n.turbidity.value=4.5,n.rayleigh.value=3,n.mieCoefficient.value=.0045,n.mieDirectionalG.value=.86,n.sunPosition.value.copy(f),n.cloudCoverage.value=.32,n.cloudDensity.value=.35,n.cloudElevation.value=.55,l(t.geometry),l(t.material),t},m=p(2500);u.add(m);let h=l(new Lc(r)),g=new Pn;g.add(p(50));let _=new ti(l(new aa(60,32)),l(new Ur({color:`#2e2a27`})));_.rotation.x=-Math.PI/2,_.position.y=-.5,g.add(_),u.environment=l(h.fromScene(g,.02,.1,200)).texture,u.environmentIntensity=1.25,u.fog=new Nn(new Z(`#57506a`),.0014);let v=new Ws(`#ff9a5c`,.6);v.position.set(f.x,.09,f.z).normalize().multiplyScalar(80).add(new q(0,0,-5)),v.castShadow=!0,v.shadow.mapSize.set(2048,2048),Object.assign(v.shadow.camera,{left:-13,right:13,top:13,bottom:-13,near:40,far:140}),v.target.position.set(0,0,-5),v.shadow.bias=-3e-4,v.shadow.normalBias=.02,u.add(v,v.target);let y=new Ws(`#c3cbff`,1.3);y.position.set(-8,5,10),u.add(y);let b=r.capabilities.getMaxAnisotropy(),S=(e,t,n,r=!0)=>{let i=document.createElement(`canvas`);i.width=e,i.height=t,n(i.getContext(`2d`));let o=l(new ea(i));return r&&(o.colorSpace=Be),o.anisotropy=b,o.wrapS=o.wrapT=a,o},C=(e,t,n,r,i,a=0)=>{let o=e.createImageData(t,n);for(let e=0;e<o.data.length;e+=4){let t=(Math.random()-.5)*i;a&&Math.random()<a&&(t+=40+Math.random()*40),o.data[e]=r[0]+t,o.data[e+1]=r[1]+t,o.data[e+2]=r[2]+t,o.data[e+3]=255}e.putImageData(o,0,0)},w=(e,t)=>S(128,128,n=>{let r=n.createRadialGradient(64,64,0,64,64,64);r.addColorStop(0,e),r.addColorStop(1,t),n.fillStyle=r,n.fillRect(0,0,128,128)}),T=w(`rgba(0,0,0,.85)`,`rgba(0,0,0,0)`),E=w(`rgba(255,255,255,1)`,`rgba(255,255,255,0)`),D=new Tn;u.add(D);let O=-270,k=S(1024,1024,e=>{C(e,1024,1024,[52,52,55],34,.012),e.globalAlpha=.25;for(let t=0;t<90;t++)e.fillStyle=Math.random()<.5?`#1c1c1f`:`#5d5d61`,e.beginPath(),e.arc(Math.random()*1024,Math.random()*1024,2+Math.random()*6,0,7),e.fill()}),A=S(512,512,e=>C(e,512,512,[128,128,128],120),!1),j=S(256,1024,e=>{e.fillStyle=`#d0d0d0`,e.fillRect(0,0,256,1024);for(let t=0;t<40;t++)e.fillStyle=`rgba(${Math.random()<.5?`90,90,90`:`230,230,230`},${.15+Math.random()*.25})`,e.fillRect(Math.random()*256,Math.random()*1024,20+Math.random()*90,30+Math.random()*200);e.fillStyle=`rgba(120,120,120,.45)`,e.fillRect(54,0,34,1024),e.fillRect(168,0,34,1024)},!1),M=l(new Eo(9,720,1,1));{let e=M.attributes.uv,t=new Float32Array(e.count*2);for(let n=0;n<e.count;n++)t[n*2]=e.getX(n),t[n*2+1]=e.getY(n)*(720/ap),e.setXY(n,e.getX(n)*9/2,e.getY(n)*720/2);M.setAttribute(`uv1`,new pr(t,2))}j.channel=1;let N=new ti(M,l(new Bo({map:k,bumpMap:A,bumpScale:.6,roughnessMap:j,roughness:.95,metalness:0})));N.rotation.x=-Math.PI/2,N.position.set(-1.8000000000000003,0,O),N.receiveShadow=!0,D.add(N);let P=l(new Bo({color:`#e8e6df`,roughness:.6,polygonOffset:!0,polygonOffsetFactor:-2})),ee=(e,t)=>{let n=new ti(l(new Eo(t,720)),P);n.rotation.x=-Math.PI/2,n.position.set(e,.004,O),n.receiveShadow=!0,D.add(n)};ee(-5.8500000000000005,.15),ee(2.25,.15);let te=new Di(l(new Eo(.12,3).rotateX(-Math.PI/2)),P,60),ne=new X;for(let e=0;e<60;e++)te.setMatrixAt(e,ne.makeTranslation(-3.6/2,.005,90-e*12));te.receiveShadow=!0,D.add(te);let F=new Di(l(new ia(.1,.02,.1)),l(new Bo({color:`#fff4d0`,emissive:`#ffd27a`,emissiveIntensity:1.5})),30);for(let e=0;e<30;e++)F.setMatrixAt(e,ne.makeTranslation(-3.6/2,.01,84-e*24));D.add(F);let re=l(new Bo({map:S(512,512,e=>C(e,512,512,[98,90,78],60,.04)),roughness:1}));for(let[e,t]of[[-7.500000000000001,2.4],[3.9000000000000004,2.4]]){let n=l(new Eo(t,720)),r=n.attributes.uv;for(let e=0;e<r.count;e++)r.setXY(e,r.getX(e)*t/3,r.getY(e)*720/3);let i=new ti(n,re);i.rotation.x=-Math.PI/2,i.position.set(e,-.02,O),i.receiveShadow=!0,D.add(i)}let ie=S(512,512,e=>{C(e,512,512,[66,72,38],30);for(let t=0;t<4e3;t++)e.fillStyle=Math.random()<.5?`rgba(40,52,22,.8)`:`rgba(120,112,60,.6)`,e.fillRect(Math.random()*512,Math.random()*512,1,3+Math.random()*4)}),ae=1400,oe=l(new Eo(ae,920));{let e=oe.attributes.uv;for(let t=0;t<e.count;t++)e.setXY(t,e.getX(t)*ae/4,e.getY(t)*920/4)}let se=new ti(oe,l(new Bo({map:ie,roughness:1,color:`#9a9a88`})));se.rotation.x=-Math.PI/2,se.position.set(0,-.05,-370),se.receiveShadow=!0,D.add(se);let I=4.9,L=new La,ce=[[0,0],[.03,.04],[0,.08],[.03,.16],[0,.24],[.03,.28],[0,.32]];L.moveTo(ce[0][0],ce[0][1]),ce.slice(1).forEach(([e,t])=>L.lineTo(e,t)),[...ce].reverse().forEach(([e,t])=>L.lineTo(e-.006,t));let le=l(new So(L,{depth:720,bevelEnabled:!1,steps:1})),ue=l(new Bo({color:`#a8b0b4`,metalness:.85,roughness:.42})),de=new ti(le,ue);de.position.set(I,.55,-630),de.scale.x=-1,de.castShadow=!0,de.receiveShadow=!0,D.add(de);let fe=new Di(l(new ia(.1,.9,.15)),ue,360);for(let e=0;e<360;e++)fe.setMatrixAt(e,ne.makeTranslation(4.98,.45,90-e*2));fe.castShadow=!0,D.add(fe);let pe=new Di(l(new ia(.02,.12,.08)),l(new Bo({color:`#ffb347`,emissive:`#ff9a1f`,emissiveIntensity:2.4})),60);for(let e=0;e<60;e++)pe.setMatrixAt(e,ne.makeTranslation(4.86,.78,90-e*12));D.add(pe);let me=l(new Bo({color:`#7d8589`,metalness:.8,roughness:.45})),he=l(new Bo({color:`#fff3d6`,emissive:`#ffe2ad`,emissiveIntensity:9})),ge=new Ma(new q(0,8.2,0),new q(0,9.6,0),new q(3.2,9.4,0)),_e=l(jd([new oa(.08,.14,8.4,12).translate(0,4.2,0).toNonIndexed(),new ko(ge,16,.055,8).toNonIndexed(),new ia(.8,.12,.3).translate(3.45,9.36,0).toNonIndexed()])),ve=l(new ia(.66,.02,.22).translate(3.45,9.29,0)),ye=l(new Ur({map:E,color:`#ffcf8a`,transparent:!0,opacity:.16,blending:2,depthWrite:!1})),be=l(new Eo(11,15).rotateX(-Math.PI/2));for(let e=90;e>-630;e-=ap){let t=new Tn;t.position.set(5.800000000000001,0,e),t.rotation.y=Math.PI;let n=new ti(_e,me);n.castShadow=!0;let r=new ti(ve,he),i=new ti(be,ye);i.position.set(3.45,.012,0),t.add(n,r,i),D.add(t)}let xe=(()=>{let e=7;return()=>(e=e*16807%2147483647,e/2147483647)})(),Se=()=>(xe()+xe()+xe()-1.5)/1.5,Ce=e=>S(256,512,t=>{let n=[],r=(e,i,a,o,s,c)=>{let l=e+Math.cos(o)*a,u=i-Math.sin(o)*a;if(t.strokeStyle=c>3?`#3b3129`:`#2c261f`,t.lineWidth=s,t.lineCap=`round`,t.beginPath(),t.moveTo(e,i),t.quadraticCurveTo((e+l)/2+Se()*a*.15,(i+u)/2,l,u),t.stroke(),c===0){n.push([l,u,a]);return}let d=xe()<.35?3:2;for(let e=0;e<d;e++)r(l,u,a*(.6+xe()*.16),o+(e-(d-1)/2)*(.55+xe()*.35)+Se()*.2,s*.66,c-1)};r(128+Se()*6,512,74+e*7,Math.PI/2+Se()*.08,10,5);for(let e=0;e<3;e++)for(let[r,i,a]of n){let n=26+Math.floor(a*.8);for(let a=0;a<n;a++){let n=Math.min(250,Math.max(6,r+Se()*26)),a=Math.max(8,i+Se()*17-6),o=e===2?Math.max(0,(n-128)/128+(256-a)/512):0,s=34+xe()*18+o*50,c=44+xe()*20+o*38,l=26+xe()*10+o*10;t.fillStyle=`rgb(${s|0},${c|0},${l|0})`,t.beginPath(),t.ellipse(n,a,2+xe()*4.5,1.5+xe()*3,xe()*3.14,0,7),t.fill()}}}),we=new Eo(1.1,2).translate(0,1,0),Te=l(jd([we.clone(),we.clone().rotateY(Math.PI/2)]));{let e=Te.attributes.normal;for(let t=0;t<e.count;t++)e.setXYZ(t,.2,.9,.35)}let Ee=Math.ceil(720/ap),De=Array.from({length:4},(e,t)=>new Di(Te,l(new Bo({map:Ce(t),alphaTest:.3,alphaToCoverage:!0,side:2,roughness:1})),210)),Oe=[];for(let e=0;e<14;e++){let t=e<7,n=xe()<.5?I+(t?8:26)+xe()*(t?14:70):-6.300000000000001-(t?16:30)-xe()*(t?14:70);Oe.push({x:n,z:xe()*ap,s:4+xe()*3.5,r:xe()*3.14,kind:Math.floor(xe()*4)})}let ke=[,,,,].fill(0),Ae=new kt,R=new q,je=new q,Me=new q(0,1,0);for(let e=0;e<Ee;e++)for(let t of Oe)Ae.setFromAxisAngle(Me,t.r),R.set(t.s,t.s,t.s),je.set(t.x,-.1,90-e*ap-t.z),De[t.kind].setMatrixAt(ke[t.kind]++,ne.compose(je,Ae,R));De.forEach((e,t)=>{e.count=ke[t],D.add(e)});let Ne=(e,t)=>{let n=Math.sin(e*127.1+t*311.7)*43758.5453;return n-Math.floor(n)},z=(e,t)=>{let n=Math.floor(e),r=Math.floor(t),i=e-n,a=t-r,o=i*i*(3-2*i),s=a*a*(3-2*a),c=Ne(n,r),l=Ne(n+1,r),u=Ne(n,r+1),d=Ne(n+1,r+1);return c+(l-c)*o+(u-c)*s+(c-l-u+d)*o*s},Pe=(e,t)=>{let n=0,r=1,i=1;for(let a=0;a<6;a++)n+=r*z(e*i,t*i),r*=.5,i*=2;return n/1.97},B=l(new Eo(3200,700,320,70));B.rotateX(-Math.PI/2);let V=B.attributes.position;for(let e=0;e<V.count;e++){let t=V.getX(e),n=V.getZ(e),r=(350-n)/700,i=Math.min(1,Math.abs(t+60)/260),a=Pe(t/210+3,n/210)**1.7*260;V.setY(e,Math.max(0,a*Math.min(1,r*1.6)*(.35+.65*i)-8))}B.computeVertexNormals();let Fe=new ti(B,l(new Bo({color:`#23271f`,roughness:1})));Fe.position.set(0,0,-1e3),u.add(Fe);let Ie=np(l,b);u.add(Ie.root);let Le=new ti(l(new Eo(3.6,19)),l(new Ur({map:T,transparent:!0,depthWrite:!1,opacity:.85})));Le.rotation.x=-Math.PI/2,Le.position.set(0,.006,-5.5),Le.renderOrder=-1,u.add(Le);let Re={rig:null,z:-60,wait:3,paint:0,paints:[]},ze=[`#b9bec4`,`#7a0f14`,`#1c2a44`,`#13807a`,`#e9e7e2`],Ve=new Id;Ve.setMeshoptDecoder(Lf);let He=window.setTimeout(()=>e?.(),9e3);window.clearTimeout(He),i||e?.(),Ve.load(ip,e=>{let t=e.scene,n=new Set;if(t.traverse(e=>{let t=e;t.isMesh&&(t.castShadow=!0,t.receiveShadow=!0,l(t.geometry),(Array.isArray(t.material)?t.material:[t.material]).forEach(e=>n.add(e)))}),n.forEach(e=>{l(e);let t=e;for(let e of[`map`,`normalMap`,`roughnessMap`,`metalnessMap`,`aoMap`,`emissiveMap`]){let n=t[e];n&&(n.anisotropy=b,l(n))}}),i){c.forEach(e=>e.dispose());return}let r=e=>[...n].find(t=>t.name===e),a=l(new Vo({color:`#07090c`,roughness:.04,metalness:.1,clearcoat:1,clearcoatRoughness:.02,envMapIntensity:1.6})),o=r(`Headlight`);o&&(o.emissive=new Z(`#fff4e0`),o.emissiveIntensity=6);let s=r(`Brakelight`);s&&(s.emissive=new Z(`#ff1a0a`),s.emissiveIntensity=3.5);let d=l(new Vo({color:ze[0],metalness:.6,roughness:.3,clearcoat:1,clearcoatRoughness:.16,normalMap:r(`Paint 1 Carmine`)?.normalMap??null}));d.normalScale.set(.15,.15);let f=l(new Vo({color:`#0c0d10`,metalness:.4,roughness:.3,clearcoat:1,clearcoatRoughness:.1})),p=e=>e.name===`Glass`?a:e.name.startsWith(`Paint 1`)?d:e.name.startsWith(`Paint 2`)?f:e;t.traverse(e=>{let t=e;t.isMesh&&(t.material=Array.isArray(t.material)?t.material.map(p):p(t.material))});let m=[];t.traverse(e=>{/^Wheel(Front|Rear)[LR]$/.test(e.name)&&m.push(e)});for(let e of m)e.rotation.set(0,0,0),e.children.filter(e=>/BrakePad/.test(e.name)).forEach(t=>e.parent?.attach(t));let h=new ti(l(new Eo(2.9,5.2)),l(new Ur({map:T,transparent:!0,depthWrite:!1,opacity:.9})));h.rotation.x=-Math.PI/2,h.position.set(0,.006,.24),h.renderOrder=-1;let g=new Tn;g.add(t,h),g.visible=!1,u.add(g),Re.rig={root:g,wheels:m},Re.paints=[[d,ze[0]]]},void 0,()=>void 0);let Ue=new qf(r,new Jt(1,1,{type:x,samples:4}));Ue.addPass(new Jf(u,d));let We=new Xf(new K(1,1),.38,.35,4);Ue.addPass(We),Ue.addPass(new Qf);let Ge=new Wf({uniforms:{tDiffuse:{value:null},time:{value:0},aspect:{value:1}},vertexShader:`varying vec2 vUv; void main(){ vUv = uv; gl_Position = projectionMatrix * modelViewMatrix * vec4(position,1.0); }`,fragmentShader:`
        ...
        }`});Ue.addPass(Ge),c.push(Ue,We);let Ke={x:0,y:0,tx:0,ty:0},qe=e=>{Ke.tx=e.clientX/window.innerWidth-.5,Ke.ty=e.clientY/window.innerHeight-.5};window.addEventListener(`pointermove`,qe);let Je=()=>{let e=n.clientWidth,t=n.clientHeight;r.setSize(e,t,!1),r.setPixelRatio(s*Ye),Ue.setPixelRatio(s*Ye),Ue.setSize(e,t),d.aspect=e/t,d.fov=d.aspect<.8?40:30,d.updateProjectionMatrix(),Ge.uniforms.aspect.value=d.aspect},Ye=1,Xe=()=>Je(),Ze=new ResizeObserver(Je);Ze.observe(n),Je();let Qe=new q(0,2,.5),$e=0,H=0,U=new q,et=new q,tt=0,nt=performance.now(),rt=0,W=e=>{let t=Math.min(.05,(e-nt)/1e3);nt=e;let n=e/1e3,r=o?0:op*t;if(tt+=r,D.position.z=-(tt%ap),Ie.update(n,o?0:11*t),Re.rig){let e=Re.rig;Re.wait>0?(Re.wait-=t,Re.wait<=0&&(Re.paint=(Re.paint+1)%ze.length,Re.paints[0][0].color.set(ze[Re.paint]),Re.z=-45,e.root.visible=!0)):(o||(Re.z+=sp*t),e.root.position.set(-3.6,0,Re.z),e.wheels.forEach(e=>{e.rotation.x+=(o?0:20)*t}),Re.z>70&&(e.root.visible=!1,Re.wait=9+Math.random()*6))}Ke.x+=(Ke.tx-Ke.x)*.04,Ke.y+=(Ke.ty-Ke.y)*.04;let i=d.aspect<.8,a=o?0:Math.sin(n*.05),s=+!o,c=-((i?.5:.66)+a*.14+Ke.x*.12),l=i?30:22;if(d.position.set(Math.sin(c)*l+Math.sin(n*1.9)*.012*s,(i?2.2:1.45)-Ke.y*.5+Math.sin(n*2.3)*.014*s,Math.cos(c)*l).add(Qe),et.set(Math.cos(c),0,-Math.sin(c)),U.copy(Qe).addScaledVector(et,i?.6:3.2),U.y=i?-2.4:2.1,d.lookAt(U),$e++,H+=t,$e===90){let e=H/$e;e>.026&&Ye>.55?(Ye=Math.max(.55,Ye*.8),Xe()):e>.026&&We.enabled&&(We.enabled=!1),$e=0,H=0}Ge.uniforms.time.value=n%100,m.material.uniforms.time.value=n,Ue.render(t),rt=requestAnimationFrame(W)};rt=requestAnimationFrame(W);let it=()=>{cancelAnimationFrame(rt),document.hidden||(nt=performance.now(),rt=requestAnimationFrame(W))};return document.addEventListener(`visibilitychange`,it),()=>{i=!0,window.clearTimeout(He),cancelAnimationFrame(rt),document.removeEventListener(`visibilitychange`,it),window.removeEventListener(`pointermove`,qe),Ze.disconnect(),c.forEach(e=>e.dispose()),r.dispose(),r.domElement.remove()}},[e]),(0,rp.jsx)(`div`,{ref:t,className:`scene3d`,"aria-hidden":!0})}export{cp as default};